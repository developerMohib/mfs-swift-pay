...
export const validateRegistrationFields = (fields: {
  ...
  if (!userName || !userEmail || !password || !userPhone || !userNID || !userRole) {
...
export const findExistingRecords = async (
  ...
  console.log(119,"Checking existing records for:", { normalizedEmail, phone, nid });
